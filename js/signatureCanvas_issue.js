...
document.addEventListener('DOMContentLoaded', () => {
  const canvasIds = [
    "requesterSignatureCanvas",
    "issuerSignatureCanvas",
    "ehsSignatureCanvas",
    "contractorSupervisorSignatureCanvas",
    "clearanceSignatureCanvas1",
    "clearanceSignatureCanvas2",
    "clearanceSignatureCanvas3",
    "clearanceSignatureCanvas4",
    "clearanceSignatureCanvas5",
    "clearanceSignatureCanvas6",
    "clearanceSignatureCanvas7"
  ];

  canvasIds.forEach(initializeSignaturePad);
});
