...
document.addEventListener('DOMContentLoaded', () => {
  initializeSignaturePad("extensionRequesterSignatureCanvas");
  initializeSignaturePad("extensionIssuerSignatureCanvas");
  initializeSignaturePad("extensionEhsSignatureCanvas");
  initializeSignaturePad("extensionContractorSupervisorSignatureCanvas");
});
